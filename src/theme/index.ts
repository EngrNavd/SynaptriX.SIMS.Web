...
// Dark mode palette (your current theme)
...
const components = (mode: PaletteMode) => ({
  ...
  MuiTableCell: {
    styleOverrides: {
      head: {
        backgroundColor: mode === 'dark' ? '#2D3748' : '#F8FAFC',
        fontWeight: 700,
  ...
  MuiChip: {
    styleOverrides: {
      ...
      colorPrimary: {
        backgroundColor: mode === 'dark' ? 'rgba(37, 99, 235, 0.15)' : 'rgba(10, 36, 99, 0.1)',
        color: mode === 'dark' ? '#60A5FA' : '#0A2463',
        border: `1px solid ${mode === 'dark' ? 'rgba(96, 165, 250, 0.3)' : 'rgba(10, 36, 99, 0.3)'}`,
      },
      colorSecondary: {
    ...
    styleOverrides: {
      root: {
        ...
        '&.Mui-focused .MuiOutlinedInput-notchedOutline': {
          borderColor: mode === 'dark' ? '#3B82F6' : '#0A2463',
          borderWidth: '2px',
          boxShadow: mode === 'dark' 
  ...
  MuiMenuItem: {
    styleOverrides: {
      root: {
        ...
        margin: '2px 8px',
        '&:hover': {
          backgroundColor: mode === 'dark' ? 'rgba(59, 130, 246, 0.12)' : 'rgba(10, 36, 99, 0.08)',
        },
        '&.Mui-selected': {
          backgroundColor: mode === 'dark' ? 'rgba(37, 99, 235, 0.2)' : 'rgba(10, 36, 99, 0.15)',
          color: mode === 'dark' ? '#60A5FA' : '#0A2463',
          fontWeight: 600,
          '&:hover': {
            backgroundColor: mode === 'dark' ? 'rgba(37, 99, 235, 0.3)' : 'rgba(10, 36, 99, 0.2)',
          },
        },
      },
    },
  ...
  MuiTooltip: {
    styleOverrides: {
      tooltip: {
        ...
        fontWeight: 500,
        padding: '8px 12px',
        border: `1px solid ${mode === 'dark' ? 'rgba(100, 116, 139, 0.3)' : 'rgba(255, 255, 255, 0.1)'}`,
        boxShadow: mode === 'dark' 
